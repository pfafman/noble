  ...
  while (i + 1 < eir.length) {
    ...
    switch (eirType) {
      ...
      case 0xff: // Manufacturer Specific Data
        if (leMetaEventType == LE_META_EVENT_TYPE_SCAN_RESPONSE && advertisement.manufacturerData) {
          // Allow having manufacturer data in the scan response too, without
          // overwriting the one in the original advertisement
          advertisement.manufacturerData2 = bytes;
        } else {
